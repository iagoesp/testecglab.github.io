...
<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en' lang='en'>	<head>
		<title>CGL @ ETHZ - Video Archive</title>
...
<div class="container contentWrapper">
	<div class="row navTools">
		...
		<div class="col-lg-8 col-sm-8 col-xs-12 breadCrumb">
			<!--<a href='http://www.ethz.ch'>ETH Zurich</a> &raquo; <a href='http://www.inf.ethz.ch/'>D-INFK</a> &raquo; <a href='http://ivc.ethz.ch/'>IVC</a> &raquo;--> <a href='/'>CGL</a>  &raquo; <a href='/publications/'>Publications</a> &raquo; <a href='/publications/videos.php'>Video Archive</a>		</div>
		<!-- end breadcrumb -->	
		<!-- search -->	
		...
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-xs-6 col-sm-3 sidebar-offcanvas noLeftPadding" id="sidebar" role="navigation">
				<div class="list-group sideMenu">
					<a href='/publications/papers/' class='list-group-item'>Papers</a><a href='/publications/techreports.php' class='list-group-item'>Technical Reports</a><a href='/publications/books.php' class='list-group-item'>Books</a><a href='/publications/tutorials.php' class='list-group-item'>Tutorials</a><a href='/publications/dissertations.php' class='list-group-item'>Dissertations</a><a href='/publications/varia.php' class='list-group-item'>Varia</a><a href='/publications/videos.php' class='list-group-item active'>Video Archive</a>				</div>
			</div>
			<!--  end side menu -->
			<div class="col-xs-12 col-sm-9">
				...
				<h2 class="pageTitle">Video Archive</h2>
				<!-- CONTENT STARTS HERE -->
				
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="content">
	<tr>
		<td>
			<h2>SIGGRAPH 2005 Papers Video Trailer</h2>

			<table width="100%" class="content">
				<tr>
					<td>
						<ul>
							<li><a href="/Downloads/Publications/Videos/siggraph2005_papersvideo.mov">Quicktime (mov)</a>: 157 MB</li>
							<li><a href="/Downloads/Publications/Videos/siggraph2005_papersvideo.avi">Divx (avi)</a> : 57 MB</li>
							<li><a href="/Downloads/Publications/Videos/siggraph2005_papersvideo.wmv">Window Media Video (wmv)</a> : 13 MB</li>
						</ul>
					</td>
					<td> &nbsp;
					</td>
					<td align="left">
						  <img alt='SIGGRAPH 2005' src='images/siggraph.gif' border='0' width='198' height='78'/>					</td>
				</tr>
			</table>
		</td>
	</tr>
