 	<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en' lang='en'>	<head>
		<title>CGL @ ETHZ - Monocular RGB Hand Pose Inference from Unsupervised Refinable Nets</title>
...
<!-- Side menu page -->
<body class="Monocular RGB Hand Pose Inference from Unsupervised Refinable Nets">
<script>
	...
	<!-- <div class="row"> Marcel removed this -->
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-xs-12 col-sm-9">
				...
				<h2 class="pageTitle">Monocular RGB Hand Pose Inference from Unsupervised Refinable Nets</h2>
				<!-- CONTENT STARTS HERE -->
				<b>E. Dibra, S. Melchior, A. Balkis, T. Wolf, C. &Ouml;ztireli, M. Gross</b><br/><br/><i>To appear: IEEE Conference on Computer Vision and Pattern Recognition (CVPR) Workshops (3D Humans 2018) (Salt Lake City, USA, June 18-22, 2018)</i><br/><p/><h3>Abstract</h3> CNN-based approaches are typically data-hungry, and when the task to solve is monocular RGB hand pose inference, obtaining real labelled training data is very hard to obtain. To overcome this, in this work we propose a new, large, realistically rendered, available hand dataset and a neural network trained on it, with the ability to refine itself to real unlabeled RGB images, given unlabeled corresponding depth images. We benchmark and validate our method on available and captured datasets, demonstrating that we strongly compare and even outperform state-of-the-art methods on tasks varying from 3D pose estimation to hand gesture recognition.		
		<p/><p/>
		<center>
		
		<video width="640" height="360" controls><source src="/Downloads/Publications/PaperVideos/2018/Dib18a.mp4" type="video/mp4">Unfortunately, your browser does not support the video tag.</video>		
		</center>
		<br><p/><h3>Downloads</h3><table border='0' cellspacing='16'><tr><td align='center'/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Dib18a/Dib18a.pdf'><img src='images/PDF.png' alt='Download Paper' border='0'/></a><br/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Dib18a/Dib18a.pdf'>[PDF]</a></td><td align='center'/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Dib18a/Dib18a_supp.pdf'><img src='images/PDF.png' alt='Download Paper' border='0'/></a><br/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Dib18a/Dib18a_supp.pdf'>[PDF suppl.]</a></td><td align='center'/><a href='/Downloads/Publications/PaperVideos/2018/Dib18a.mp4'><img src='images/Quicktime.png' alt='Download Video' border='0'/></a><br/><a href='/Downloads/Publications/PaperVideos/2018/Dib18a.mp4'>[Video]</a></td><td align='center'/><a href='/Downloads/Publications/Papers/2018/Dib18a/Dib18a.bib'><img src='images/Text.png' alt='Download Paper' border='0'/></a><br/><a href='/Downloads/Publications/Papers/2018/Dib18a/Dib18a.bib'>[BibTeX]</a></td></tr></table>				<!-- CONTENT ENDS HERE -->
			</div>
			<!-- end content -->
		</div>
