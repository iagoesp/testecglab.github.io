 	<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en' lang='en'>	<head>
		<title>CGL @ ETHZ - PuppetPhone: Puppeteering Virtual Characters Using a Smartphone</title>
...
<!-- Side menu page -->
<body class="PuppetPhone: Puppeteering Virtual Characters Using a Smartphone">
<script>
	...
	<!-- <div class="row"> Marcel removed this -->
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-xs-12 col-sm-9">
				...
				<h2 class="pageTitle">PuppetPhone: Puppeteering Virtual Characters Using a Smartphone</h2>
				<!-- CONTENT STARTS HERE -->
				<b>R. Anderegg, L. Ciccone, R. W. Sumner</b><br/><br/><i>MIG '18 Proceedings of the 11th ACM SIGGRAPH Conference on Motion, Interaction and Games (Limassol, Cyprus, November 8-10, 2018), pp. 5:1--5:6</i><br/><p/><h3>Abstract</h3> Video games enable the representation and control of characters that can agilely evolve in virtual environments. However, the detached character interaction they propose -- often using a push-button metaphor -- is far from the satisfactory feeling of grasping and moving physical toys. In this paper, we propose a new interaction metaphor that reduces the gap between physical toys and virtual characters. The user moves a smartphone around, and a puppet that responds in real time to the manipulations is seen through the screen. The virtual character moves in order to follow the user gestures, as if it was attached to the phone via a rigid stick. This yields a natural interaction, similar to moving a physical toy, and the puppet now feels alive because its movements are augmented with compelling animations. Using the smartphone, our method ties together the control of the character and camera into a single interaction mechanism. We validate our system by presenting an application in Augmented Reality.
		
		<p/><p/>
		<center>
		
		<video width="640" height="360" controls><source src="/Downloads/Publications/PaperVideos/2018/Cic18a.mp4" type="video/mp4">Unfortunately, your browser does not support the video tag.</video>		
		</center>
		<br><p/><h3>Downloads</h3><table border='0' cellspacing='16'><tr><td align='center'/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Cic18a/Cic18a.pdf'><img src='images/PDF.png' alt='Download Paper' border='0'/></a><br/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Cic18a/Cic18a.pdf'>[PDF]</a></td><td align='center'/><a href='/Downloads/Publications/PaperVideos/2018/Cic18a.mp4'><img src='images/Quicktime.png' alt='Download Video' border='0'/></a><br/><a href='/Downloads/Publications/PaperVideos/2018/Cic18a.mp4'>[Video]</a></td><td align='center'/><a href='/Downloads/Publications/Papers/2018/Cic18a/Cic18a.bib'><img src='images/Text.png' alt='Download Paper' border='0'/></a><br/><a href='/Downloads/Publications/Papers/2018/Cic18a/Cic18a.bib'>[BibTeX]</a></td></tr></table>				<!-- CONTENT ENDS HERE -->
			</div>
			<!-- end content -->
		</div>
