 	<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en' lang='en'>	<head>
		<title>CGL @ ETHZ - Visualization and Analysis of Deep Water Asteroid Impacts</title>
...
<!-- Side menu page -->
<body class="Visualization and Analysis of Deep Water Asteroid Impacts">
<script>
	...
	<!-- <div class="row"> Marcel removed this -->
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-xs-12 col-sm-9">
				...
				<h2 class="pageTitle">Visualization and Analysis of Deep Water Asteroid Impacts</h2>
				<!-- CONTENT STARTS HERE -->
				<b>R. Imahorn, I. Baeza Rojo, T. G&uuml;nther</b><br/><br/><i>IEEE Scientific Visualization Contest (Berlin, Germany, October 21-26, 2018), , vol. , no. , 2018, pp.  </i><br/><p/><h3>Abstract</h3> As evident by the Earth's history, severe asteroid impacts pose a significant threat to all species living on our planet. The severity of an impact is difficult to predict due to the vast amount of dependent parameters and thus the potential consequences on climate, plate tectonics and organisms are not yet fully understood. To improve our understanding of the threats imposed by asteroid impacts, scientists at Los Alamos National Laboratory conducted an ensemble simulation for varying impact scenarios into deep water oceans. The IEEE Scientific Visualization Contest 2018 is dedicated to the visual analysis of these asteroid impact simulations. In this paper, we apply a number of recent state-of-the-art visualization techniques to visually compare and analyze the varying impact scenarios. We discuss both automatic approaches applicable to an in-situ analysis, as well as interactive approaches for a detailed exploration.		
		<p/><p/>
		<center>
		
		<video width="640" height="360" controls><source src="/Downloads/Publications/PaperVideos/2018/Ibr18b.mp4" type="video/mp4">Unfortunately, your browser does not support the video tag.</video>		
		</center>
		<br><p/><h3>Downloads</h3><table border='0' cellspacing='16'><tr><td align='center'/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Ibr18b/Ibr18b.pdf'><img src='images/PDF.png' alt='Download Paper' border='0'/></a><br/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Ibr18b/Ibr18b.pdf'>[PDF]</a></td><td align='center'/><a href='/Downloads/Publications/PaperVideos/2018/Ibr18b.mp4'><img src='images/Quicktime.png' alt='Download Video' border='0'/></a><br/><a href='/Downloads/Publications/PaperVideos/2018/Ibr18b.mp4'>[Video]</a></td><td align='center'/><a href='/Downloads/Publications/Papers/2018/Ibr18b/Ibr18b.bib'><img src='images/Text.png' alt='Download Paper' border='0'/></a><br/><a href='/Downloads/Publications/Papers/2018/Ibr18b/Ibr18b.bib'>[BibTeX]</a></td></tr></table>				<!-- CONTENT ENDS HERE -->
			</div>
			<!-- end content -->
		</div>
