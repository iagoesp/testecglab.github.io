 	<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en' lang='en'>	<head>
		<title>CGL @ ETHZ - PointProNets: Consolidation of Point Clouds with Convolutional Neural Networks</title>
...
<!-- Side menu page -->
<body class="PointProNets: Consolidation of Point Clouds with Convolutional Neural Networks">
<script>
	...
	<!-- <div class="row"> Marcel removed this -->
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-xs-12 col-sm-9">
				...
				<h2 class="pageTitle">PointProNets: Consolidation of Point Clouds with Convolutional Neural Networks</h2>
				<!-- CONTENT STARTS HERE -->
				<b>R. Roveri, A. C. &Ouml;ztireli, I. Pandele, M. Gross</b><br/><br/><i>To appear: Proceedings of Eurographics (Delft, The Netherlands, April 16-20, 2018), Computer Graphics Forum, vol. 37, no. 2</i><br/><p/><h3>Abstract</h3> With the widespread use of 3D acquisition devices, there is an increasing need of consolidating captured noisy and sparse point
...
to the state-of-the-art.
		...
		<video width="640" height="360" controls><source src="/Downloads/Publications/PaperVideos/2018/Rov18a.mp4" type="video/mp4">Unfortunately, your browser does not support the video tag.</video>		
		</center>
		<br><p/><h3>Downloads</h3><table border='0' cellspacing='16'><tr><td align='center'/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Rov18a/Rov18a.pdf'><img src='images/PDF.png' alt='Download Paper' border='0'/></a><br/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Rov18a/Rov18a.pdf'>[PDF]</a></td><td align='center'/><a href='/Downloads/Publications/PaperVideos/2018/Rov18a.mp4'><img src='images/Quicktime.png' alt='Download Video' border='0'/></a><br/><a href='/Downloads/Publications/PaperVideos/2018/Rov18a.mp4'>[Video]</a></td><td align='center'/><a href='/Downloads/Publications/Papers/2018/Rov18a/Rov18a.bib'><img src='images/Text.png' alt='Download Paper' border='0'/></a><br/><a href='/Downloads/Publications/Papers/2018/Rov18a/Rov18a.bib'>[BibTeX]</a></td></tr></table>				<!-- CONTENT ENDS HERE -->
			</div>
			<!-- end content -->
		</div>
