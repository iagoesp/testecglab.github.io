 	<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en' lang='en'>	<head>
		<title>CGL @ ETHZ - Ten Years of Research on Intelligent Educational Games for Learning Spelling and Mathematics</title>
...
<!-- Side menu page -->
<body class="Ten Years of Research on Intelligent Educational Games for Learning Spelling and Mathematics">
<script>
	...
	<!-- <div class="row"> Marcel removed this -->
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-xs-12 col-sm-9">
				...
				<h2 class="pageTitle">Ten Years of Research on Intelligent Educational Games for Learning Spelling and Mathematics</h2>
				<!-- CONTENT STARTS HERE -->
				<b>B. Solenthaler, S. Klingler, T. K&auml;ser, M. Gross</b><br/><br/><i>arXiv:1806.03257, 2018</i><br/><p/><h3>Abstract</h3> In this article, we present our findings from ten years of research on intelligent educational games. We discuss the architecture of our training environments for learning spelling and mathematics, and specifically focus on the representation of the content and the controller that enables personalized trainings. We first show the multi-modal representation that reroutes information through multiple perceptual cues and discuss the game structure. We then present the data-driven student model that is used for a personalized, adaptive presentation of the content. We further leverage machine learning for analytics and visualization tools targeted at teachers and experts. A large data set consisting of training sessions of more than 20,000 children allows statistical interpretations and insights into the nature of learning.<br><p/><h3>Downloads</h3><table border='0' cellspacing='16'><tr><td align='center'/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Sol18a/Sol18a.pdf'><img src='images/PDF.png' alt='Download Paper' border='0'/></a><br/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Sol18a/Sol18a.pdf'>[PDF]</a></td><td align='center'/><a href='/Downloads/Publications/Papers/2018/Sol18a/Sol18a.bib'><img src='images/Text.png' alt='Download Paper' border='0'/></a><br/><a href='/Downloads/Publications/Papers/2018/Sol18a/Sol18a.bib'>[BibTeX]</a></td></tr></table>				<!-- CONTENT ENDS HERE -->
			</div>
			<!-- end content -->
		</div>
