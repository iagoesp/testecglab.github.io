 	<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en' lang='en'>	<head>
		<title>CGL @ ETHZ - Visualization of Clouds and Atmospheric Air Flows</title>
...
<!-- Side menu page -->
<body class="Visualization of Clouds and Atmospheric Air Flows">
<script>
	...
	<!-- <div class="row"> Marcel removed this -->
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-xs-12 col-sm-9">
				...
				<h2 class="pageTitle">Visualization of Clouds and Atmospheric Air Flows</h2>
				<!-- CONTENT STARTS HERE -->
				<b>N. Rimensberger, M. Gross, T. G&uuml;nther</b><br/><br/><i>IEEE Computer Graphics and Applications, , vol. , no. , 2018, pp. </i><br/><p/><h3>Abstract</h3> The IEEE Scientific Visualization Contest 2017 addressed the arising challenges in the visualization and analysis of atmospheric cloud-resolving simulations. In this article, we utilize direct and indirect methods to represent atmospheric attributes such as cloud water content and air pressure, and employ Eulerian and Lagrangian techniques for air flow visualization.
		
		<p/><p/>
		<center>
		
		<video width="640" height="360" controls><source src="/Downloads/Publications/PaperVideos/2018/Rim18a.mp4" type="video/mp4">Unfortunately, your browser does not support the video tag.</video>		
		</center>
		<br><p/><h3>Downloads</h3><table border='0' cellspacing='16'><tr><td align='center'/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Rim18a/Rim18a.pdf'><img src='images/PDF.png' alt='Download Paper' border='0'/></a><br/><a href='/disclaimer.php?dlurl=/Downloads/Publications/Papers/2018/Rim18a/Rim18a.pdf'>[PDF]</a></td><td align='center'/><a href='/Downloads/Publications/PaperVideos/2018/Rim18a.mp4'><img src='images/Quicktime.png' alt='Download Video' border='0'/></a><br/><a href='/Downloads/Publications/PaperVideos/2018/Rim18a.mp4'>[Video]</a></td><td align='center'/><a href='/Downloads/Publications/Papers/2018/Rim18a/Rim18a.bib'><img src='images/Text.png' alt='Download Paper' border='0'/></a><br/><a href='/Downloads/Publications/Papers/2018/Rim18a/Rim18a.bib'>[BibTeX]</a></td></tr></table>				<!-- CONTENT ENDS HERE -->
			</div>
			<!-- end content -->
		</div>
